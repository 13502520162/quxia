...
Page({
  data: {
    ...
    funcList: [
      ...
      { title: '场地管理', icon: '../../assets/images/location.png', desc: "管理投放场地", pageUrl: '../manage/place/list/list', premission: 15, hide: true },
      { title: '库存管理', icon: '../../assets/images/repertory.png', desc: "库存信息管理", pageUrl: '../manage/inventory/list', premission: 31, hide: true },
      { title: '补货', icon: '../../assets/images/scan.png', desc: "扫码补货", pageUrl: '../manage/replenish/replenish', premission: 43, hide: true },
      { title: '货道状态', icon: '../../assets/images/location.png', desc: "货道状态信息", pageUrl: '../manage/shelfsStatus/list', premission: 54, hide: true },
      { title: '优惠券', icon: '../../assets/images/coupon2.png', desc: "优惠券管理", pageUrl: '../manage/coupon/coupon', premission: 55, hide: true },
    ],
